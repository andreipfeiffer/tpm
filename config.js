...
config.mysql.populate.todos = ''
	+ 'INSERT INTO `' + config.mysql.database + '`.`todos` (`id`, `id_user`, `title`, `isCompleted`) VALUES'
	+ '  (1, 1, \'Learn Ember\', 0)'
...
config.mysql.populate.users = ''
	+ 'INSERT INTO `' + config.mysql.database + '`.`users` (`id`, `email`, `password`, `date_created`) VALUES'
