...
describe('Auth Controllers', () => {
    ...
    describe('LoginController', () => {
        ...
        beforeEach(inject((_$httpBackend_, _$location_, $rootScope, $controller, _AuthToken_, _feedback_) => {
    ...
    describe('LogoutController', () => {
        ...
        beforeEach(inject((_$httpBackend_, _$location_, $rootScope, $controller, _AuthToken_) => {
            $httpBackend = _$httpBackend_;
            location     = _$location_;
            AuthToken    = _AuthToken_;
            scope        = $rootScope.$new();
