module.exports = function(knex) {
    ...
    function getProjectsReport(idUser) {
        ...
        q += 'SELECT projects.id, idClient, projects.name, clients.name AS clientName, priceEstimated, priceFinal, date, projects.status, CONCAT(YEAR(filtered_projects.date), "-" , MONTH(filtered_projects.date)) AS month';
